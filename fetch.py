#!/usr/bin/env python3
"""
Recupero codici sconto Volotea da shopilo.it
Sursa: https://shopilo.it/negozi/volotea.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/volotea.com"
STORE_NAME = "Volotea"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Volotea da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-volotea)"
    }
    try:
